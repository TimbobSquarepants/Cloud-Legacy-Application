...
<sql:query var="comp3732_employees" dataSource="${database}">
    SELECT * FROM comp3732_employees 
    WHERE comp3732_employees.firstName AND comp3732_employees.lastName = ? <sql:param value="dept_id"/>
</sql:query>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2>Retrieved Employee</h2>


            <c:choose>
                <c:when test = "${comp3732_employeesDetails eq null}">
                    <p>Your search did not retrieve any results please re-enter employee
                        first and last name</p>
                    </c:when>

                <c:otherwise>
                    <p>
                        Below you will find information Employee information from your
                        search results.
                    </p>
                            ...
                            <div id="home" class="tab-pane fade in active">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <dl>
                                        ...
                                        <dd>${comp3732_employeesDetails.email}</dd>
                                        <dt>Phone </dt>
                                        ...
                                        <core:if test = "${objectList.employee_name eq employeeName}">
                                            <dl>
                                                ...
                                                <c:choose> 
                                                    ...
                                                    <c:otherwise>
                                                        <dt>Email </dt>
                                                        <dd>${objectList.contact_email}</dd>
                                                    </c:otherwise>
                                                </c:choose>
