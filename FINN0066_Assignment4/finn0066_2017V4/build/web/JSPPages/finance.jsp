<%-- 
    Document   : finance
    Created on : 29/08/2017, 11:05:42 AM
    Author     : finn0066
--%>
...
<sql:query var="comp3732_employees" dataSource="${database}">
    ...
    AND comp3732_departments.dept_id = ? <sql:param value="3"/>
</sql:query>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="./finance.jsp">Finance</a></li>
         ...
         <div class="container">
            <h2>Finance Department Employees</h2>
            <p>
                Below you will find information relating to employee's
                who are employeed in Finance positions. Select a tab from below
