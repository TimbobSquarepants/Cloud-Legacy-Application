<%-- 
    Document   : shipping
    Created on : 29/08/2017, 11:06:19 AM
    Author     : finn0066
--%>
...
<sql:query var="comp3732_employees" dataSource="${database}">
    ...
    AND comp3732_departments.dept_id = ? <sql:param value="10"/>
</sql:query>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="./shipping.jsp">Shipping</a></li>
            </ul>
        </div>
    </nav>
         ...
         <div class="container">
            <h2>Shipping Employees</h2>
            <p>
                Below you will find information relating to employee's
                who are in control of Shipping. Select a tab from below
