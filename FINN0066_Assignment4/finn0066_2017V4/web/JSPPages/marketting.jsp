<%-- 
    Document   : marketting
    Created on : 29/08/2017, 11:06:09 AM
    Author     : finn0066
--%>
...
<sql:query var="comp3732_employees" dataSource="${database}">
    ...
    AND comp3732_departments.dept_id = ? <sql:param value="9"/>
</sql:query>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active" ><a href="./marketting.jsp">Marketting</a></li>
         ...
         <div class="container">
            <h2>Marketting Employees</h2>
            <p>
                Below you will find information relating to employee's
                who are in Marketting positions. Select a tab from below
