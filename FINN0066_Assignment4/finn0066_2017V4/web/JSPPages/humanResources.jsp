<%-- 
    ...
    Created on : 29/08/2017, 11:05:34 AM
    Author     : finn0066
--%>
...
<sql:query var="comp3732_employees" dataSource="${database}">
    ...
    AND comp3732_departments.dept_id = ? <sql:param value="2"/>
</sql:query>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="./humanResources.jsp">Human Resrouces</a></li>
         ...
         <div class="container">
            ...
            <p>
                Welcome to Human Resources were we take pride and value in looking
                at your personal history. Below is our list of employees working for us
            </p>
