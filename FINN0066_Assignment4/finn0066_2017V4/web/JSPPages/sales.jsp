<%-- 
    Document   : sales
    Created on : 29/08/2017, 11:21:03 AM
    Author     : finn0066
--%>
...
<sql:query var="comp3732_employees" dataSource="${database}">
    ...
    AND comp3732_departments.dept_id = ? <sql:param value="8"/>
</sql:query>
...
<html>
 ...
 <div class="container">
            <h2>Sales Department Employees</h2>
            <p>
                Below you will find information relating to employee's
                who are working in sales positions. Select a tab from below
